...
from tmdbot.helpers import esc, split_into_chunks
from tmdbot.keyboards import get_main_keyboard, build_media_keyboard, build_chunk_keyboard
...
async def send_movie_list(bot, chat_id, header: str, movies_info, detail_action: str = "det", media_type: str = "m"):
    ...
    for mid, title, desc in movies_info:
        ...
        if len(chunk_text) + len(line) > max_size and chunk_movies_list:
            ...
            state._chunk_movies[cid] = (chunk_movies_list, detail_action, media_type)
