  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        myPythonWithPackages = pkgs.python3.withPackages (
          python-packages:
          (myPyPackages python-packages)
      ...
      in
      {
        packages = {
          inherit tmdbot;
          bookbot = tmdbot; # Same source, setup.py produces both entry points
          default = tmdbot;
        };
        # TODO use stdEnv?
